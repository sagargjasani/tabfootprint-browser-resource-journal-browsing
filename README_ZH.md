...
独立的项目设计文档，适用对象： **Desktop browsers**。
...
- **标签页工作负载清单** (Tab workload manifest) — 规划模块，尚未实现。
- **扩展实验笔记** (Extension experiment notes) — 规划模块，尚未实现。
- **内存采样比较** (Memory sample comparisons) — 规划模块，尚未实现。
