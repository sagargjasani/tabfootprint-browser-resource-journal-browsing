...
<div align="center">
  <img src="./public/logo.svg" alt="TabFootprint — Desktop browsers — Browsing" width="64" height="64">
  <h1>TabFootprint — Desktop browsers — Browsing</h1>
</div>

An independent project specification for Desktop browsers, covering tab workload manifest, extension experiment notes, memory sample comparisons.
...
<img src="./public/screenshots/desktop-main.svg" alt="Desktop browsers — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Desktop browsers — compact concept, not a screenshot" width="250">
<br>
...
- **Tab workload manifest** — planned module; not implemented.
- **Extension experiment notes** — planned module; not implemented.
- **Memory sample comparisons** — planned module; not implemented.

The proposed workflow separates tab workload manifest from extension experiment notes, with memory sample comparisons retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Tab workload manifest**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TabFootprint — Desktop browsers — Browsing — specification review workflow">
<br>
...
### Tab workload manifest

Define the input and expected outcome for module 1. Record the Desktop browsers version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Extension experiment notes

Define the input and expected outcome for module 2. Record the Desktop browsers version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Memory sample comparisons

Define the input and expected outcome for module 3. Record the Desktop browsers version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Tab workload manifest |
